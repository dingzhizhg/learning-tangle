...
#     train_stat_metrics = tangle.test_model(test_single, clients, set_to_use='train')
    ...
    #   transactions = {n['name']: Transaction(None, set(n['dirparent']), set(n['parents']), n['name'], n['time'], n['malicious'] if 'malicious' in n else False) for n in t['nodes']}
