...
def train_single(u, g, flops, seed, train_data, eval_data, tangle_name, malicious_node, poison_type):
    ...
    args = parse_args()
    tx, metrics, comp = node.process_next_batch(args.num_epochs, args.batch_size, args.num_tips, args.reference_avg_top)
...
def test_single(u, g, flops, seed, train_data, eval_data, tangle_name, set_to_use):
    ...
    # 处理parents的list
    parents = [set(tangle.transactions[tx].parents) for tx in reference_txs]
